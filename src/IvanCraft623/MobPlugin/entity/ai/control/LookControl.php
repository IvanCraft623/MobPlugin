...
class LookControl {
	...
	protected function rotateTowards(float $float1, float $float2, float $float3): float {
		$degreesDifference = Utils::degreesDifference($float1, $float2);
		return $degreesDifference + Utils::clamp($degreesDifference, -$float3, $float3);
	}
}